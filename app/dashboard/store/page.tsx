  ...
  return (
    <div>
      ...
      <div className="mb-4 flex justify-between items-center">
        <p>Manage your store items below</p>
        <Link 
          ...
          {totalPages > 1 && (
            <div className="flex justify-center mt-4">
              <button
                ...
                className="px-3 py-1 bg-gray-200 rounded-l-md disabled:bg-gray-100 disabled:text-gray-400"
              >
                Previous
              </button>
              <div className="px-4 py-1 bg-white border-t border-b">
                Page {currentPage + 1} of {totalPages}
              </div>
              <button
                onClick={() => setCurrentPage(p => Math.min(totalPages - 1, p + 1))}
                disabled={currentPage === totalPages - 1}
                className="px-3 py-1 bg-gray-200 rounded-r-md disabled:bg-gray-100 disabled:text-gray-400"
              >
                Next
              </button>
            </div>
