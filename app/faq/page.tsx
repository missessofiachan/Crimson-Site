...
export default function FAQPage() {
  return (
    <div className="container min-h-screen flex flex-col items-center justify-center text-primary">
      <h1 className="title text-gray-900">Frequently Asked Questions</h1>
      <div className="w-full max-w-2xl space-y-6 mb-8">
        <div className="bg-white/90 rounded-lg shadow p-6">
          <h2 className="font-semibold text-lg mb-2 text-primary">What is Crimson E-Commerce?</h2>
        ...
        <div className="bg-white/90 rounded-lg shadow p-6">
          <h2 className="font-semibold text-lg mb-2 text-primary">How can I place an order?</h2>
          <p className="text-base text-gray-800">
        ...
        <div className="bg-white/90 rounded-lg shadow p-6">
          <h2 className="font-semibold text-lg mb-2 text-primary">How can I track my order?</h2>
          <p className="text-base text-gray-800">
